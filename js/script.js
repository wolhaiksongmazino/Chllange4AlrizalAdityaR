...
class Rules {
  constructor() {
    ...
    this.resultContainer = document.getElementById("vs-result");
    this.user_choice;
    this.com_choice;
  }
...
class Game extends Rules {
  ...
  setPlayerListener = () => {
    this.user.batu[0].onclick = () => {
      ...
      this.user.batu[0].classList.add("active-choice");
      this.user.kertas[0].classList.remove("active-choice");
      this.user.gunting[0].classList.remove("active-choice");
    ...
    this.user.kertas[0].onclick = () => {
      ...
      this.user.batu[0].classList.remove("active-choice");
      this.user.kertas[0].classList.add("active-choice");
      this.user.gunting[0].classList.remove("active-choice");
      this.removePlayerListener();
      this.decideResult();
    };
    ...
    this.user.gunting[0].onclick = () => {
      ...
      this.user.batu[0].classList.remove("active-choice");
      this.user.kertas[0].classList.remove("active-choice");
      this.user.gunting[0].classList.add("active-choice");
      this.removePlayerListener();
      this.decideResult();
    };
  };
  ...
  setComListener(choice) {
    switch (choice) {
      case "batu":
        ...
        this.com.batu[1].classList.add("active-choice");
        this.com.kertas[1].classList.remove("active-choice");
        this.com.gunting[1].classList.remove("active-choice");
        break;
      case "kertas":
        this.getComPick("kertas");
        this.com.batu[1].classList.remove("active-choice");
        this.com.kertas[1].classList.add("active-choice");
        this.com.gunting[1].classList.remove("active-choice");
        break;
      case "gunting":
        ...
        this.com.batu[1].classList.remove("active-choice");
        this.com.kertas[1].classList.remove("active-choice");
        this.com.gunting[1].classList.add("active-choice");
        break;
      default:
        break;
    }
